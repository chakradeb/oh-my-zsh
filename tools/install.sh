main() {
  ...
  env git clone --depth=1 https://github.com/debuc/oh-my-zsh.git -b develop $ZSH || {
  ...
  printf "${GREEN}"
  echo '         __                                     __           ______    '
  echo '  ____  / /_     ____ ___  __  __   ____  _____/ /_         /  __   \'
  echo ' / __ \/ __ \   / __ `__ \/ / / /  /_  / / ___/ __ \       /  /  /  /'
  echo '/ /_/ / / / /  / / / / / / /_/ /    / /_(__  ) / / /      /  /__/  /'
  echo '\____/_/ /_/  /_/ /_/ /_/\__, /    /___/____/_/ /_/      /________/'
